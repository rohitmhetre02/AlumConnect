    ...
    <div className="space-y-10">
      ...
      <header className="text-center py-2">
        ...
        <p className="text-slate-600 max-w-xl mx-auto">
          Discover upcoming alumni-led events and gatherings.
        </p>
        ...
        {canCreateEvent && (
          <div className="mt-6">
            <Link
              ...
              className="inline-flex items-center rounded-full bg-primary px-6 py-2 text-sm font-semibold text-white transition hover:bg-primary-dark"
            >
              + Create Event
            </Link>
          </div>
          ...
          : (
            <div className="col-span-full rounded-3xl border border-dashed border-slate-200 bg-white p-12 text-center">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Once alumni publish events, they will appear here.
                {canCreateEvent ? ' Be the first to host one!' : ''}
              </p>
            </div>
          )}
