...
const PostEvent = () => {
  ...
  const handleImageUpload = async (event) => {
    ...
    console.log('=== DEBUG: PostEvent handleImageUpload called ===')
    ...
    try {
      ...
      if (result?.url) {
        ...
        console.log('User event image uploaded successfully:', result.url)
      } else {
        throw new Error('No URL returned from upload')
      }
    } catch (error) {
      console.error('=== USER EVENT UPLOAD ERROR ===')
