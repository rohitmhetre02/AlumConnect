        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">AlumConnect</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-blue-100">Anantrao Pawar College of Engineering & Research</p>
                  <p className="text-blue-100">Pune, Maharashtra 411041</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-blue-100">+91 20 1234 5678</p>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-blue-100">alumni@apcoer.edu</p>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="https://www.apcoer.edu" className="text-blue-100 hover:text-white transition-colors">
                  www.apcoer.edu
                </a>
              </div>
            </div>
