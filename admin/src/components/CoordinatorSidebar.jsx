        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto px-4 pb-10 scrollbar-hide">
            ...
            <div className="mb-6">
              ...
              />
              <NavItem icon={<Calendar size={18} />} label="Events" path="/admin/events" />
              <NavItem icon={<Briefcase size={18} />} label="Opportunities" path="/admin/opportunities" />
              <NavItem icon={<Heart size={18} />} label="Campaigns" path="/admin/campaigns" />
              <NavItem icon={<GraduationCap size={18} />} label="Mentorship" path="/admin/mentorship" />
              <NavItem icon={<Newspaper size={18} />} label="News" path="/admin/news" />
              <NavItem icon={<Image size={18} />} label="Gallery" path="/admin/gallery" />
            </div>
          ...
          <div className="p-4 bg-slate-50 border-t border-slate-200">
            <div className="flex items-center space-x-3 px-2 py-2">
              <div className="w-8 h-8 rounded-full bg-slate-300 flex items-center justify-center text-white font-semibold text-sm">
                A
              </div>
