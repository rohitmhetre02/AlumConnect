...
const AdminPostEvent = () => {
  ...
  const eventModes = ['in-person', 'virtual', 'hybrid']
  ...
  const handleImageUpload = async (event) => {
    ...
    console.log('=== DEBUG: AdminPostEvent handleImageUpload called ===')
    ...
    try {
      console.log('Calling uploadFile with type: event')
      ...
      if (result?.url) {
        ...
        console.log('Admin event image uploaded successfully:', result.url)
      } else {
        throw new Error('No URL returned from upload')
      }
    } catch (error) {
      console.error('=== ADMIN EVENT UPLOAD ERROR ===')
  ...
  const handleSubmit = async (event) => {
    ...
    const endAtISO = buildISODateTime(form.endDate, form.endTime)
